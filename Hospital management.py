...
cn = ms.connect(host="localhost", user="root", passwd="ajmal1121")
cur = cn.cursor()
            ...
            while (True):
                ...
                if a == 1:
                    ...
                    # Add new member into hosptial team
                        ...
                        if c == 1:
                            ...
                            cur.execute(
                                "insert into doctors values('" + name + "','" + dep + "','" + age + "','" + city + "','" + mno + "','" + fees + "','" + sal + "')")
                            cn.commit()
                        ...
                        # New nurse details
                            ...
                            cur.execute(
                                "insert into nurses values('" + name + "','" + age + "','" + city + "','" + mno + "','" + str(
                                    sal) + "')")
                            cn.commit()
                        ...
                        # New worker details
                            ...
                            cur.execute(
                                "insert into workers values('" + name + "','" + age + "','" + city + "','" + mno + "','" + ms + "')")
                            cn.commit()
                ...
                # entering the patient details table
                    ...
                    # Admit a new patient
                        ...
                        cur.execute("insert into patients values('" + str(pid) + "','" + str(name) + "','" + str(
                            mn) + "','" + str(age) + "','" + str(city) + "','" + str(dr) + "')")
                        cn.commit()
